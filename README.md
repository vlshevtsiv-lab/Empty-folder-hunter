...
The user selects a folder using the Select Folder button.

The application recursively scans the directory using os.walk.

Any folders that contain no files and no subfolders are considered empty.

The results are displayed in the main results panel.

The user can choose to remove all empty folders using the clean all button.
